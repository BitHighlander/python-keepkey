...
class TestMsgCosmosSigntx(common.KeepKeyTest):
    ...
    def test_cosmos_signtx_data(self):
        self.setup_mnemonic_nopin_nopassphrase()
        self.client.apply_policy('AdvancedMode', 0)
    ...
    def test_cosmos_signtx_message(self):
        self.setup_mnemonic_nopin_nopassphrase()
        self.client.apply_policy('AdvancedMode', 1)
    ...
    def test_cosmos_signtx_newcontract(self):
        self.setup_mnemonic_nopin_nopassphrase()
        self.client.apply_policy('AdvancedMode', 1)

        # contract creation without data should fail.
        self.assertRaises(Exception, self.client.cosmos_sign_tx,
            n=[0, 0],
            nonce=123456,
            gas_price=20000,
            gas_limit=20000,
    ...
    def test_cosmos_sanity_checks(self):
        self.setup_mnemonic_nopin_nopassphrase()
        self.client.apply_policy('AdvancedMode', 1)
    ...
    def test_cosmos_signtx_nodata_eip155(self):
    ...
    def test_cosmos_signtx_data_eip155(self):
        self.setup_mnemonic_allallall()
        self.client.apply_policy('AdvancedMode', 1)
